...
export const Careers = () => {
  return (
    <section className="pt-20 md:pt text-ggg-gray-200">
      ...
      <div className="pt-8 md:pt-12 font-light font-pop text-2xl ">
        <ul className="md:h-32 md:flex md:flex-col md:flex-wrap lg:text-[60px] lg:h-full lg:grid lg:grid-cols-2 lg:gap-10">
